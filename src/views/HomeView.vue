...
<template>
	...
	<div class="mb-10 text-center">
		<div class="badge-soft badge badge-lg h-auto p-1 mb-4" v-if="currentHostname !== demoHostname">
			🌐 Check out live demo: <a :href="`https://${ demoHostname }`" class="link">https://{{ demoHostname }}</a>
		</div>
		<br>
		<div class="badge-soft badge badge-lg h-auto p-1 mb-4">
			<svg class="size-5" viewBox="0 -3.5 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
				<g fill="currentColor">
			...
			GitHub repository: <a :href="githubRepo" class="link">{{ githubRepo }}</a>
		</div>
	</div>
